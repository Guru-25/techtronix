...
{
 $chart_data .= "{ Hameglobin_A1C_Test:'".$row["Hameglobin_A1C_Test"]."', Hameglobin_A1C_Test:".$row["Hameglobin_A1C_Test"].", Hameglobin_A1C_Test:".$row["Hameglobin_A1C_Test"]." }, ";
...
<p align="right"><a href="vinput.php" class="btn btn-success" >Back</a> </p>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Your Hameglobin A1C Test Statistics</h2>
...
Morris.Bar({
 ...
 xkey:'Hameglobin_A1C_Test',
 ykeys:['Hameglobin_A1C_Test'],
 labels:['Hameglobin_A1C_Test'],
  barColors: ["#ff00bf"],
 hideHover:'auto',
 stacked:true
});
