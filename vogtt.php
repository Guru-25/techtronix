...
{
 $chart_data .= "{ Oral_Glucose_Tolerance_Test:'".$row["Oral_Glucose_Tolerance_Test"]."', Oral_Glucose_Tolerance_Test:".$row["Oral_Glucose_Tolerance_Test"].", Oral_Glucose_Tolerance_Test:".$row["Oral_Glucose_Tolerance_Test"]." }, ";
...
<p align="right"><a href="vinput.php" class="btn btn-success" >Back</a> </p>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Your Oral Glucose Tolerance Test Statistics</h2>
...
Morris.Bar({
 ...
 xkey:'Oral_Glucose_Tolerance_Test',
 ykeys:['Oral_Glucose_Tolerance_Test'],
 labels:['Oral_Glucose_Tolerance_Test'],
  barColors: ["#bf00ff"],
 hideHover:'auto',
 stacked:true
});
