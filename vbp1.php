...
{
 $chart_data .= "{ Blood_Pressure1:'".$row["Blood_Pressure1"]."', Blood_Pressure1:".$row["Blood_Pressure1"].", Blood_Pressure1:".$row["Blood_Pressure1"]." }, ";
...
<p align="right"><a href="vinput.php" class="btn btn-success" >Back</a> </p>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Your Blood Pressure(Systolic) Statistics</h2>
...
Morris.Bar({
 ...
 xkey:'Blood_Pressure1',
 ykeys:['Blood_Pressure1'],
 labels:['Blood_Pressure1'],
  barColors: ["#00ffff"],
 hideHover:'auto',
 stacked:true
});
