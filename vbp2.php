...
{
 $chart_data .= "{ Blood_Pressure2:'".$row["Blood_Pressure2"]."', Blood_Pressure2:".$row["Blood_Pressure2"].", Blood_Pressure2:".$row["Blood_Pressure2"]." }, ";
...
<p align="right"><a href="vinput.php" class="btn btn-success" >Back</a> </p>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Your Blood Pressure(Distolic) Statistics</h2>
...
Morris.Bar({
 ...
 xkey:'Blood_Pressure2',
 ykeys:['Blood_Pressure2'],
 labels:['Blood_Pressure2'],
  barColors: ["#0040ff"],
 hideHover:'auto',
 stacked:true
});
