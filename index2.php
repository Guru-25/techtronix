...
<body id="bdy">
	...
	<div class="wrap">
		...
		<div>
			...
			<h1 style="display: block;">Welcome To HealthTrack!</h1>
              <h4>  <p>HealthTrack is an Application which provides personalized recommendation to its users in the form of diet and exercise.The users can get the prediction wheather they are having diabetes or not. If they are predicted positive then personalized diet and exercise are recommended to the users.</p> 
...
<footer >
		<div class="f1">
			...
			<p class="text-right text-info">  &copy; 2024  HealthTrack</p>
			</div>
